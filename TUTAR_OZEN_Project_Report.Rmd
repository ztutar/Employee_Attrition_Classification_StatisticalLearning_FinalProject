...
```{r data_targetdist, out.width="65%"}
...
main="Attrition Distribution", cex=1, radius=1)
```
...
```{r, echo=FALSE}
data <- data.frame(
  Model = c("Basic Logistic Classifier", 
            "Logistic Regression with Backward Stepwise Search", 
            "Logistic Regression with Elastic Net", 
            "Linear Discriminant Analysis", 
            "Quadratic Discriminant Analysis"),
  Accuracy = c(0.7215, 0.7226, 0.7214, 0.7336, 0.7130),
  F1_Score = c(0.7593, 0.7601, 0.7609, 0.7471, 0.6968),
  Precision = c(0.6889, 0.6901, 0.6864, 0.7315, 0.6923),
  Recall = c(0.8456, 0.8458, 0.8536, 0.7633, 0.7012)
)
...
Accuracy: All models were competitive, with gml.ELNET and LDA being the highest.
F1 Score: gml.ELNET excelled, indicating better handling of false positives and negatives.
Precision and Recall: gml.ELNET showed a superior balance, crucial for reliable attrition prediction.
