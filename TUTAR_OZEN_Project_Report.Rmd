...
plot.roc(y.test, glm.BACKWARD.predict, add=TRUE, legacy.axes=TRUE, percent=TRUE, 
    xlab="False Positive %", ylab="True Positive %", col="indianred3", lwd=4,
    print.auc=TRUE, print.auc.y=50, print.auc.x=30, quiet = TRUE)

plot.roc(y.test, glm.ELNET.predict, add=TRUE, legacy.axes=TRUE, percent=TRUE, 
    xlab="False Positive %", ylab="True Positive %", col="lightpink2", lwd=4,
    print.auc=TRUE, print.auc.y=40, print.auc.x=30, quiet = TRUE)

legend("bottomright",legend=c("glm.FULL","glm.BACKWARD","glm.ELNET"),
       col=c("firebrick4","indianred3","lightpink2"),lwd=4)
